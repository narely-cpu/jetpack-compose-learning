...
class EditUserUseCase @Inject constructor(val managementUserRepository: ManagementUserRepository) {
    ...
    suspend fun invoke(
        ...
        try {
            ...
            managementUserRepository.updateUser(id = collaborator.id, request = request)
